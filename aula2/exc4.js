...
// Exc 4:
function verificarPosicaoPacienteFila(nome) {
  const posicao = pacientes.indexOf(nome);
  if (posicao == ! -1) {
    return console.log(posicao + 1);
  }
  else {
    return console.log("O paciente não foi encontrado.")
  }

}

let paciente = "Isis Tatiane Sophie Santos";

verificarPosicaoPacienteFila(paciente);
